...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DashboardApi = __webpack_require__(34);
	...
	var DashboardComponent = function (_React$Component) {
	    ...
	    _createClass(DashboardComponent, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            (0, _DashboardApi2.default)(1).then(function (jsondata) {
	                _store2.default.dispatch({ type: 'load_dshboard', data: jsondata });
	            });

	            _store2.default.subscribe(function () {
	                _this2.setState({ dashboard: JSON.stringify(_store2.default.getState().dashboard) });
	            });
	        }
	    }, {
	        key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ApiUrl = __webpack_require__(35);

	var _ApiUrl2 = _interopRequireDefault(_ApiUrl);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GetDashboard = function GetDashboard(userId) {
	    var optins = {
	        method: 'GET',
	        headers: new Headers({ 'x-user-id': userId })
	    };
	    return fetch(_ApiUrl2.default + '/dashboard', optins).then(function (result) {
	        return result.json();
	    });
	};
...
/***/ function(module, exports) {
	...
	var ApiUrl = 'http://react-api.azurewebsites.net';
